/*
 * Permissions and Roles storage service provider
 * ---
 * A mongoDB service for storage of Permissions and Roles created in the Auth0 dashboard.
 * To use this service, replace the file.js service in the api code file (`var db = require("../db");`)
 * ---
 * Author: James Darbyshire (github.com/darbio), adapted from Auth0 file provider
 * License: MIT
 */
